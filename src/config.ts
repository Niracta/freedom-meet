  ...
  links: [
    {
      ...
      url: `https://rtaylor.design`,
      label: `Portfolio`
    },
    {
      Icon: SiLinkedin,
      url: `https://www.linkedin.com/in/rtaylordesign/`,
      label: `LinkedIn`
    },
    {
      Icon: SiGmail,
      url: `mailto:designer.racheltaylor@gmail.com`,
      label: `Email`
    },
    {
      Icon: SiSpotify,
      url: `https://open.spotify.com/user/8btjsb2b9tprvld11rp5x0pol?si=7b438d96f2704417`,
      label: `Spotify`
    },
    {
      Icon: SiInstagram,
      url: `https://www.instagram.com/the_crow_wizard/`,
      label: `Instagram`
    },
    {
      Icon: SiTwitter,
      url: `https://twitter.com/rtaylor_design`,
      label: `Twitter`
    },
